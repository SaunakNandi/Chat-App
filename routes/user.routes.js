...
import { login, newUser, getMyProfile, logout, searchUser, sendFrndReq, getMyNotifications, acceptFrndReq, getMyFriends, getUserDetails, updateMyProfile } from '../controllers/user.controller.js';
