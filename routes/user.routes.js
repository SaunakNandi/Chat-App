...
import { login, newUser, getMyProfile, logout, searchUser, sendFrndReq, getMyNotifications, acceptFrndReq, getMyFriends, getUserDetails } from '../controllers/user.controller.js';
